...
connection definition will be used to define the credentials, scope, and configuration for interacting with an external system.
...
Levels - create at tenant, rg, or workspace....
